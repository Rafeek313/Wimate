...
public class Sending_Mail_html {
	...
	public static void main(String message1) {
		...
		String ProjectName = "Alert Verification";
		...
		message += "<table cellpadding=\"0\" cellpadding=\"0\" style=\"font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;box-sizing:border-box;width:100%;margin:0;padding:35px 0\"> <tr><th>Test Status</th><th>Results</th></tr>";
		...
		for (int c = 0; c < count; c++) {
			...
			if (Testcases_Namec.contains("Failed")) {
				message += "<tr>";
				// message += "<h4><font color=red>" + Testcases_Namec +"
				// "+LoadTime+"</font></h4>";
				...
				message += "<td bgcolor=\"#cc0000\" style=\"font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;box-sizing:border-box;padding:10px 5px;line-height:18px;border-width:3px;border-style:solid;width:2em;height:1em;border-color:#fff;font-size:20px;text-align:center;color:#e05953\"></font></h4></td>";
				message += "</tr>";
				...
				message += "<td style=\"font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;box-sizing:border-box;padding:10px 5px;color:#009900;line-height:18px;border-width:3px;border-style:solid;width:2em;height:1em;border-color:#fff;font-size:20px;text-align:center\">"
						+ Testcases_Namec + "</font></h4></td>";
				message += "<td bgcolor=\"#009900\" style=\"font-family:'Google Sans',Roboto,RobotoDraft,Helvetica,Arial,sans-serif;box-sizing:border-box;padding:10px 5px;line-height:18px;border-width:3px;border-style:solid;width:2em;height:1em;border-color:#fff;font-size:20px;text-align:center;color:#8fce00\"></font></h4></td>";
				message += "</tr>";
			} else {
			}
		}
		...
		String subject = "Alert DT Verification," + LocalDateTime.now() + "";
