...
public class Sending_Mail_html {
	...
	public static void sendEmailWithAttachments(String host, String port, final String userName, final String password,
		...
		InternetAddress[] toAddresses = { new InternetAddress(toAddress), new InternetAddress("rafeek@wimate.in"),
	...
	public static void main(String message1) {
		...
		String ProjectName = "MQTT Brokers Ping request";
		...
		String subject = "MQTT Broket Ping ," + LocalDateTime.now() + "";
