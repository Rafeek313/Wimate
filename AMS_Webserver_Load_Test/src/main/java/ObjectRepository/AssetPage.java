...
public class AssetPage {
	...
	/** 
	 * this method is used for loading  and ping testing   Asset table  in the ticket configuration
	 * @author rafeek
	 */
	public String loadAssetTable(WebDriver driver) throws IOException, Throwable {
		...
		Reporter.log("Total item of Asset table: "+totalItem,true);
		double endTime = System.currentTimeMillis();
		   double assetpageloadTimeInSeconds = (endTime - startTime)/1000;
		return assetpageloadTimeInSeconds+" seconds";
