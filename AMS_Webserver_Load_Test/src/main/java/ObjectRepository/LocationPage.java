...
public class LocationPage {
	...
	/** 
	 * this method is used for loading  and ping testing   Location table  in the ticket configuration
	 * @author rafeek
	 */
	public String loadLocationTable(WebDriver driver) throws IOException, Throwable {
		...
		Reporter.log("Total item of LocationPage table: "+totalItem,true);
		double endTime = System.currentTimeMillis();
		   double locationloadTimeInSeconds = (endTime - startTime)/1000;
		return locationloadTimeInSeconds+" seconds";
