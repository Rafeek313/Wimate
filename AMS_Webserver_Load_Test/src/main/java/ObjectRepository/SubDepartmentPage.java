...
public class SubDepartmentPage {
	 ...
	 * @author rafeek
	 */
	public String loadSubDepartmentTable(WebDriver driver) throws IOException, Throwable {
		...
		Reporter.log("Total item of sub department table: "+totalItem,true);
		double endTime = System.currentTimeMillis();
		   double subdepartmentloadTimeInSeconds = (endTime - startTime)/1000;
		return subdepartmentloadTimeInSeconds+" seconds";
