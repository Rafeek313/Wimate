...
public class AssetMapPage {
	...
	/** 
	 * this method is used for loading  and ping testing   Asset Map table  in the ticket configuration
	 * @author rafeek
	 */
	public String loadAssetMapTable(WebDriver driver) throws IOException, Throwable {
		...
		Reporter.log("Total item of Asset Map table: "+totalItem,true);
		double endTime = System.currentTimeMillis();
		   double assetmaploadTimeInSeconds = (endTime - startTime)/1000;
		return assetmaploadTimeInSeconds+" seconds";	
	    }
}
