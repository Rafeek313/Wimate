...
public class ProblemPage {
	...
	/** 
	 * this method is used for loading  and ping testing   Problem table  in the ticket configuration
	 * @author rafeek
	 */
	public String loadProblemTable(WebDriver driver) throws IOException, Throwable {
		...
		Reporter.log("Total item of Problem table: "+totalItem,true);
		double endTime = System.currentTimeMillis();
		   double problemloadTimeInSeconds = (endTime - startTime)/1000;
		return problemloadTimeInSeconds+" seconds";
