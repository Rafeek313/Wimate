...
public class HomePage {
	...
	@FindBy(xpath = "//i-feather[@ng-reflect-name='edit']")
	...
	@FindBy(xpath = "//span[contains(text(),'Reports')]/following::a[contains(text(),'Forms')]")
	...
	public void clickonFormType() throws InterruptedException {
		formsbtn.click();
		wlib.waitForElementToBeClickable(formTypebtn);
		formTypebtn.click();
	}
	...
	/**
	 * this method is used for click on report option  and action class used for scroll
	 * to the specific element
	 * 
	 * @param driver
	 * @throws InterruptedException
	 * @author rafeek
	 */
	public void clickonReportButton(WebDriver driver) throws InterruptedException {
		wlib.maximizeWindow(driver);
		dbbtn.click();
		//wlib.waitForElementToBeClickable(reportbtn);
		wlib.specificScrollAction(driver, reportbtn);
	}
	/**
	 ...
	 * @author rafeek
	 */
	public void clickonTicketButton(WebDriver driver) throws InterruptedException {
		wlib.maximizeWindow(driver);
		wlib.waitForElementToBeClickable(ticketbtn);
		wlib.specificScrollAction(driver, ticketbtn);
	}
	/**
	 * this method is used for click on Ticket option  in report page and action class used for scroll
	 * to the specific element
