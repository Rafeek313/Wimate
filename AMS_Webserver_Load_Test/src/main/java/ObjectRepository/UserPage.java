...
public class UserPage {
	...
	public void addUser(WebDriver driver) throws Throwable {
		...
		for (int i = 1; i <= rowcount; i++) {
			...
			String telegramID = elib.readDataFromExcel("User", i, 17);
			String telegramNotification = elib.readDataFromExcel("User", i, 18);
			String notificationrecieved = elib.readDataFromExcel("User", i, 19);
			String smsnotification = elib.readDataFromExcel("User", i, 20);
			String userType = elib.readDataFromExcel("User", i, 21);
