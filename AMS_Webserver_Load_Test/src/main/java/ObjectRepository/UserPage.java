...
public class UserPage {
	...
	/** 
	 * this method is used for loading  and ping testing   User table  in the ticket configuration
	 * @author rafeek
	 */
	public String loadUserTable(WebDriver driver) throws IOException, Throwable {
		...
		Reporter.log("Total item of User table: "+totalItem,true);
		double endTime = System.currentTimeMillis();
		   double userloadTimeInSeconds = (endTime - startTime)/1000;
		return userloadTimeInSeconds+" seconds";
