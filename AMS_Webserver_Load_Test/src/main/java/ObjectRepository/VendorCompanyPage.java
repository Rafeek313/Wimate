...
public class VendorCompanyPage {
	...
	/** 
	 * this method is used for loading  and ping testing   Vendor Company table  in the ticket configuration
	 * @author rafeek
	 */
	public String loadVendorCompanyTable(WebDriver driver) throws IOException, Throwable {
		...
		Reporter.log("Total item of Vendor company table: "+totalItem,true);
		double endTime = System.currentTimeMillis();
		   double vcloadTimeInSeconds = (endTime - startTime)/1000;
		return vcloadTimeInSeconds+" seconds";
