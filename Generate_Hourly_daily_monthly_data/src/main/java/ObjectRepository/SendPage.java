...
public class SendPage extends BaseClass {
	...
	public void clickLocationTree(WebDriver driver) throws Throwable {
		...
		int count = elib.getRowCount("TestData");
		System.out.println(count);
		for(int i=1;i<=count;i++)
		{

			String deviceName = elib.readDataFromExcel("TestData", i, 0);

			String dataType = elib.readDataFromExcel("TestData", i, 1);
			...
			{
				searchdevice.clear();
				String previousdevicename = elib.readDataFromExcel("TestData", i-1, 0);
				...
				String date = elib.readDataFromExcel("TestData", i, 2);
				...
				elib.writeDataIntoExcel("TestData", i, 3, "Generated successfully");
			}
		}
